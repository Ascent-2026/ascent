      ...
      <div className={styles.inner}>
        ...
        <div className={styles.body}>
          <p className={styles.paragraph}>
            <span className={styles.firstWord}>AScent</span> 2026 is where builders, dreamers, and
            problem-solvers gather to experiment with real ideas. Over three high-energy days,
            participants will step into a retro-futuristic arena designed for coding, design,
            robotics, and innovation-led collaboration.
          </p>
          <p className={styles.paragraph}>
