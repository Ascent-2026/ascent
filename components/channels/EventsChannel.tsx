...
const ALL_EVENTS = [
...

  {
    ...
    location: "Classroom C (GF)",
  },
  {
    day: "Day 1",
    time: "11:00 AM - 2:00 PM",
    title: "Judging & Wrap-Up (Hackathon)",
    location: "Complete 2nd Floor + 2nd Classroom",
  },
  {
    day: "Day 1",
  ...
  },
  {
    ...
    title: "Robotics Event(Break it 4 events)",
    location: "Turf + Volleyball Court",
  },
  {
    day: "Day 1",
    time: "1:00 PM - 5:00 PM",
    title: "LaunchPad",
    location: "SSB Classroom",
  },
  {
    day: "Day 1",
  ...
  },
  {
    ...
    title: "Tech Quiz",
    location: "Open Area near Stairs",
  },
...

  {
    ...
    location: "Pitch: SSB / Build: GF-C",
  },
  {
    day: "Day 2",
    time: "10:00 AM - 4:00 PM",
    title: "AI Buildathon",
    location: "Classroom 2C",
  },
  {
    day: "Day 2",
    time: "10:00 AM - 8:00 PM",
    title: "Kaggle Competition",
    location: "Classroom B, 1st Floor",
  },
  {
    day: "Day 2",
  ...
  },
  {
    ...
    location: "2nd Floor B1",
  },
  {
    day: "Day 2",
    time: "4:00 PM - 5:00 PM",
    title: "Talk Show (2)",
    location: "SSB Classroom / 2A",
  },
  {
    day: "Day 2",
  ...
  return (
    <div className={`${styles.channelRoot} ${styles.eventsRoot}`}>
      <div className={styles.channelInner}>
        <h1 className={`${styles.channelHeading} ${styles.eventsHeading}`}>
          Events Schedule
        </h1>
